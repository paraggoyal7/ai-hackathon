...
def detect_deviations(audio_file, pitch_threshold=150, energy_threshold=0.5, window_size=1.0, step_size=0.5):
    """
...
deviations = detect_deviations(wav_file, pitch_threshold=0.15, energy_threshold=0.2, window_size=1.0, step_size=0.5)
